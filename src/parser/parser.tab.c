...
static const yytype_uint16 yyrline[] =
{
      ...
      56,    57,    58,    59,    63,    64,    68,    69,    72,    76,
      80,    81,    84,    87,    88,    89,    90,    93,    96,    99,
     100,   101,   104,   106,   109,   110,   114,   115,   116,   117,
     118,   119,   123,   127,   131,   135,   139,   143,   144,   148,
     152,   153,   154,   155,   156,   157,   161,   165,   166,   170,
     173,   176,   177,   181,   185,   186,   187,   188,   189,   190,
     191,   192,   193,   194,   195,   199,   203,   204,   208,   212,
     213,   214,   218,   219,   222,   226,   227,   228,   229,   232,
     236,   237,   240,   242,   244,   246,   249,   253,   254,   255,
     259,   260,   264,   268,   269,   270,   271,   274,   278,   279,
     282,   286,   287
};
#endif
...
/* Line 1455 of yacc.c  */
#line 46 "parser.y"
    { fprintf(yyout, "<!DOCTYPE html>\n<html><head><style> table, th, td { border: 1px solid black; border-collapse: collapse; }</style></head><body>%s</body></html>", (yyvsp[(2) - (3)].string)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 84 "parser.y"
    { char *buf; asprintf(&buf, "<div style=\"border-color:grey;border-width:1px;border-style:inset;\">%s</div>", (yyvsp[(2) - (3)].string)); (yyval.string) = buf; ;}
    break;
